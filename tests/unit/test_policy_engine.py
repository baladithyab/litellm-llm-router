...
class TestPolicyEngine:
    ...
    @pytest.mark.asyncio
    async def test_engine_first_matching_rule_wins(self, basic_context, allow_rule, deny_rule):
    ...
    async def test_engine_fail_open_on_error(self, basic_context):
        ...
        rule._matches_patterns = lambda *args: (_ for _ in ()).throw(Exception("Test error"))
