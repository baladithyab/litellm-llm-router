...
LLMROUTER_STRATEGIES = [
    'llmrouter-knn', 'llmrouter-svm', 'llmrouter-mlp', 'llmrouter-mf',
    'llmrouter-elo', 'llmrouter-routerdc', 'llmrouter-hybrid',
    'llmrouter-causallm', 'llmrouter-graph', 'llmrouter-automix',
    'llmrouter-r1', 'llmrouter-gmt', 'llmrouter-knn-multiround',
    'llmrouter-llm-multiround', 'llmrouter-smallest', 'llmrouter-largest',
    'llmrouter-custom',
]
...
class TestStrategyValidation:
    ...
    def test_strategy_returns_model_from_list(self, strategy: str, model_list: List[str]):
